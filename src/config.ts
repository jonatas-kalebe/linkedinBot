export default {
  ...
  // Perfil conciso para a IA usar como contexto principal.
  AI_USER_PROFILE: `
    - Desenvolvedor de Software Fullstack com 4 anos de experiência, focado em Java/Spring Boot para o backend e Angular para o frontend.
    - Cursando superior em Ciência da Computação (6º período).
    - Especialista em criar APIs RESTful, microserviços e interfaces de usuário reativas.
